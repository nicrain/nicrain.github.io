...
import { getAuth } from 'https://www.gstatic.com/firebasejs/9.6.3/firebase-auth.js'; // Import getAuth from Firebase Auth
...
export const auth = getAuth(firebaseApp); // Export auth function
...
export const get_small_description =(id) => {
    const Ref = ref(database, 'evenement/' + id + '/small_description');
    let small_description;
        get(Ref)
            .then((snapshot)=>{
                small_description=snapshot.val();
                localStorage.setItem('small_description_event', small_description);
            });
        return localStorage.getItem('small_description_event');
}
...
export const set_isOpensmall_description = (isOpensmall_description) => {
    localStorage.setItem('isOpensmall_description_event', isOpensmall_description);
};

export const get_isOpensmall_description = () => {
    return localStorage.getItem('isOpensmall_description_event') === 'true';
};
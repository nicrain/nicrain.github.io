...
export const get_titre2 =(id) => {
    const Ref = ref(database, 'evenement/' + id + '/titre2');
    let titre2;
        get(Ref)
            .then((snapshot)=>{
                titre2=snapshot.val();
                localStorage.setItem('Titre2_event', titre2);
            });
        return localStorage.getItem('Titre2_event');
    
}

export const set_titre2 = (titre2, id) => {
